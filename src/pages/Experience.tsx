      ...
      <div className="max-w-5xl mx-auto">
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-4 sm:space-y-2">
                ...
                {experience.responsibilities.map((responsibility, index) => (
                  <div key={index} className="flex items-start space-x-4 bg-white/10 rounded-xl p-4 sm:space-x-2 sm:p-3">
        ...
        <div className="mt-12 text-center sm:mt-6">
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 inline-block sm:p-4">
            ...
            <p className="text-2xl font-bold bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent sm:text-lg">
